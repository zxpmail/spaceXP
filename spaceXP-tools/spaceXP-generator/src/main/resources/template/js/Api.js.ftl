...
* 根据id查询
*/
export const use${FunctionName}InfoApi = id => {
return service.get('/${functionName}/info/' + id)
}
/**
* 当主键Id存在是修改信息 不存在表示新增功能
*/
export const use${FunctionName}SubmitApi = dataForm => {
if (dataForm.id) {
...
*/
export const use${FunctionName}ListApi = (pageInfo, queryForm) => {
...
* 根据id删除信息
*/
export const use${FunctionName}DeleteApi = id => {
...
* @param ids id 数组
*/
export const use${FunctionName}BatchDeleteApi = ids => {
