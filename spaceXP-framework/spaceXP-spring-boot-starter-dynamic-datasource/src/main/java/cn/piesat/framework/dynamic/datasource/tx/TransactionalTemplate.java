 ...
 */
package cn.piesat.framework.dynamic.datasource.tx;
        ...
        try {
            switch (propagation) {
                ...
                case NEVER:
                    ...
                    if (existingTransaction()) {
                        throw new RuntimeException("Existing transaction found for transaction marked with propagation never");
                    } else {
                ...
                case MANDATORY:
                    ...
                    if (!existingTransaction()) {
                        throw new RuntimeException("No existing transaction found for transaction marked with propagation 'mandatory'");
                    }
                ...
                case NESTED:
                    ...
                    break;
                default:
                    throw new RuntimeException("Not Supported Propagation:" + propagation);
            }
