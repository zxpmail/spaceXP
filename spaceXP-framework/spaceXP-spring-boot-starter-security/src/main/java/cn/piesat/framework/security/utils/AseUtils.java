...
/**
 * <p/>
 * {@code @description}  :加解密工具
 * <p/>
 * <b>@create:</b> 2022/12/9 21:26.
 *
 * @author zhouxp
 */
...
//            kgen.init(128, new SecureRandom(key.getBytes(DEFAULT_CHARSET)));  // new SecureRandom() 在Linux环境下会导致解密失败，建议使用下面两句
            ...
            Logger.getLogger(AseUtils.class.getName()).log(Level.SEVERE,"AES 密文处理异常", e);
        }
        return null;
    }
    /**
    ...
    public static void main(String[] args) {
        ...
        String encryptIdCard = encrypt(idCard, key);
        String decryptIdCard = decrypt(encryptIdCard, key);
